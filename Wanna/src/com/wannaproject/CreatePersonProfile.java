...
import com.wannaproject.library.AlbumStorageDirFactory;
import com.wannaproject.library.BaseAlbumDirFactory;
import com.wannaproject.library.FroyoAlbumDirFactory;
import com.wannaproject.library.ImageFilePath;
...
public class CreatePersonProfile extends Activity {
	...
	private void selectImage() {
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(CreatePersonProfile.this);
	...
	public class uploadToServer extends AsyncTask<Void, Void, String> {
        ...
        private ProgressDialog pd = new ProgressDialog(CreatePersonProfile.this);
