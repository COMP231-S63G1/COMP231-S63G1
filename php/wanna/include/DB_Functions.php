...
/**
 ...
 /**
	...
	public function addUserProfile($userNickName, $userGender, $userAge, $userDescription) {
        
        $result = mysql_query("INSERT INTO profile(nickName, gender, age, description) VALUES('$userNickName', '$userGender', '$userAge', '$userDescription')");
        // check for successful store
